...
def dimensionality_reduction(mapped_embeddings, embeddings, dim_red_method, embeddings_path, n_components, save_embeddings=True, random_state=True, umap_with_best_params=False):
    if dim_red_method == 'UMAP':
        
        if umap_with_best_params:
            reducer = umap.UMAP(n_neighbors = 21
